export class SpineCharacter {
  ...
  createMesh(xShift, yShift, scale, flipX, skin) {
    ...
    skeletonMesh.state.setAnimation(0, "BladeMed_BaseIdle_001", true);
    skeletonMesh.skeleton.setSkinByName(skin);
    skeletonMesh.skeleton.scaleX = (flipX) ? -1 : 1;
    skeletonMesh.skeleton.x = xShift;
    skeletonMesh.skeleton.y = yShift;
