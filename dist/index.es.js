...
import { Box, styled, Text, Button, Stack, Flex, Divider, Image as Image$1, Grid, globalCss } from 'pizza-juice';
  ...
  createClass(CharacterStatuses, [{
    ...
    value: function getUnitStatusUpdates(unit) {
      ...
      if (this.activeAnimEvt.getCurrentEventName() === "CardReplaceEvent" && this.activeAnimEvt.isInvoker(unit.unitId)) {
        updates.push(React.createElement(
          StatusCard,
          { type: "ticks" },
          "REPLACE CARD"
        ));
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.props.unitSelectionFields.getUnits()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          units.push(React.createElement(
            "div",
            null,
            React.createElement(
              "div",
...
var BattleEndContainer = styled(Box, {
  display: "flex",
...
var BattleEndTitle = styled(Text, {
  mb: "$4",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("stop", { stopColor: "#11EEF1" }),
        React.createElement("stop", { offset: "1", stopColor: "#F70835" })
      ),
      React.createElement(
        "linearGradient",
        {
...
var PlayerControlsCard = function (_HUDComponent) {
  ...
  createClass(PlayerControlsCard, [{
    ...
    value: function render() {
      ...
      var iconMap = {
        attack: React.createElement(AttackIcon, null),
        interact: React.createElement(InteractIcon, null),
        ability: React.createElement(AbilityIcon, null),
        effect: React.createElement(EffectIcon, null)
      };
      ...
      if (!this.props.baseAttack && this.hudLocked) {
        return React.createElement(
          ...
          React.createElement(NdLogo, null)
        );
      }
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Divider, { css: { $$color: "$colors$white" } }),
          React.createElement(
            Flex,
            ...
            card.exploits && React.createElement(
              Text,
              { size: "sm", transform: "normal", css: { color: "$pink-500" } },
              card.exploits
            ),
            card.replace && React.createElement(
              Button,
              {
...
var Typename = styled("div", (_styled = {
  maxW: "66%",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Box,
        { css: { color: "$grey-700" } },
        React.createElement(Neutral, { width: "9" })
      ),
      React.createElement(
        Text,
    ...
    React.createElement(Box, { css: { h: 1, w: "$full", bg: "$grey-700" } })
  );
};
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Character, { character: this.props.targetCharacter, enemy: true })
        ),
        React.createElement(
          Flex,
          ...
          React.createElement(
            ...
            React.createElement(Stat, { label: "HP", value: stats && stats.HEALTH || 0 }),
            React.createElement(Stat, { label: "STL", value: stats && stats.STEALTH || 0 }),
            React.createElement(Stat, { label: "ATK", value: stats && stats.ATTACK || 0 }),
            React.createElement(Stat, { label: "MEC", value: stats && stats.MECH || 0 }),
            React.createElement(Stat, { label: "DEF", value: stats && stats.DEFENSE || 0 }),
            React.createElement(Stat, { label: "TAC", value: stats && stats.TACTICS || 0 }),
            React.createElement(Stat, { label: "NAN", value: stats && stats.NANO || 0 }),
            React.createElement(Stat, { label: "HAC ", value: stats && stats.HACKING || 0 })
          ),
          React.createElement(
            Button,
            {
  ...
  createClass(PlayerControlsDisplay, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.state.battleComplete && React.createElement(BattleComplete, { winner: this.state.winner, owner: this.state.owner }),
        React.createElement(
          Flex,
          {
            direction: "column",
          ...
          React.createElement(
            ...
            null,
            React.createElement(Box, { css: { h: 1, w: "$full", bg: "$grey-700" } }),
            React.createElement(Box, { css: { h: 2, w: "18%", bg: "$grey-700" } })
          ),
          React.createElement(
            Flex,
            { gap: 1, css: { h: 198, w: "$full" } },
            React.createElement(PlayerControlsCharacter, {
              character: activeCharacter,
              isTarget: false
            }),
            React.createElement(PlayerControlsCard, {
              card: {
                name: "Base Attack",
                type: "ATTACK",
                tickCost: 40
        ...
        React.createElement(
          ...
          React.createElement(TargetCharacterControls, {
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.props.unitSelectionFields.getRegions()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          targets.push(React.createElement("div", { style: {
              display: 'block',
              position: 'absolute',
              top: region.region[1],
...
var CharacterPortrait = function CharacterPortrait(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Image$1, { src: src || emptyCharacterImg, css: {} }),
      React.createElement(
        Overlay$1,
        null,
        React.createElement(
    ...
    React.createElement(Below, { enemy: enemy })
  );
};
    ...
    value: function render() {
      ...
      for (var idx = 0; idx < this.units.length; idx++) {
        if (this.units[idx].state !== "AWAKE") {
          portraits.push(React.createElement(
            Box,
            {
              css: {
                position: "relative",
    ...
    value: function update(delta) {
      ...
      ReactDOM.render(React.createElement(
        ...
        React.createElement(
          Flex,
          { justify: "between" },
          React.createElement(VersionDisplay, null),
          React.createElement(SettingsDisplay, { soundManager: this.soundManager }),
          React.createElement(TurnOrderDisplay, { teams: this.teams, units: this.units })
        ),
        React.createElement(PlayerTargetMap, {
          unitSelectionFields: this.unitSelectionFields,
          playerSelections: this.playerSelections
        }),
        React.createElement(CharacterStatuses, {
          unitSelectionFields: this.unitSelectionFields,
          playerSelections: this.playerSelections,
          activeAnimEvt: this.activeAnimEvt
        }),
        React.createElement(PlayerControlsDisplay, {
          confirmAction: this.confirmAction,
          teams: this.teams,
          units: this.units,
          playerSelections: this.playerSelections
        }),
        React.createElement(ErrorDisplay, { error: this.error })
      ), this.div);
    }
  }]);
  return CombatHUD;
...
export { CombatScene as NDCombatScene, CombatPlayer as NDCombatPlayer, CharacterEquipment as NDCharacterEquipment };
